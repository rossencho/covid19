        ...
        <div className={"list-container"}>
          <div className={"header-container"}>
            <div className={"covid-label-container"}>
              ...
              <p className={"covid-desc-txt"}>
                To get up to date results, this website collects the data
                from&nbsp;
                <a
              ...
              <p className={"covid-desc-txt"}>
                If you want to know more about the development of this website
                then visit{" "}
                <a
                  href="https://hackbotone.com/blog/covid-19-full-stack-application"
                  target="_blank"
                  rel="noopener noreferrer"
                  className={"covid-desc-link-txt"}
                >
          ...
          <div className={"search-container"}>
            <div className={"search-input-border"}>
              <img
                src={"https://assets.hackbotone.com/images/icons/ic_search.png"}
                alt="Search"
    ...
    return (
      <div className={"corona-parent-container"}>
        <div className={"header-menu-container"}>
          ...
          <a
            href="https://github.com/anshumanpattnaik/covid19-full-stack-application"
            target="_blank"
            rel="noopener noreferrer"
            className={"header-label"}
          >
          ...
          <span
            className={"header-label"}
            onClick={this.onSetAboutModal.bind(this, true)}
          >
            About
          </span>
        </div>
        {this.state.isAboutModal ? (
          <div className={"about-parent-container"}>
            <div
              className={"about-overlay-container"}
              onClick={this.onSetAboutModal.bind(this, false)}
            ></div>
            <div className={"about-modal-container"}>
              <div className={"about-modal-header"}>
                ...
                <img
                  src={
                    "https://assets.hackbotone.com/images/icons/ic_close.png"
                  }
              ...
              <div className={"about-modal-desc-container"}>
                <p className={"about-modal-description"}>
                  The idea behind this application is to displays the statistics
                  of Coronavirus COVID-19 around the world and the data are
                  ...
                  &nbsp; and it updates the cases constantly on this website
                  around the world.
                </p>
                <p className={"about-modal-description"}>
                  If you don't find any of the cases are not reflecting on this
                  website then also you can visit the&nbsp;
                  <a
              ...
              <div className={"developer-info-container"}>
                ...
                <div className={"developer-name-container"}>
                  ...
                  <a
                    href="https://hackbotone.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={"developer-website"}
                  >
                    www.hackbotone.com
                  </a>
                </div>
        ...
        >
          <img
            src={
              "https://assets.hackbotone.com/images/icons/ic_dark_map_style.PNG"
            }
            className={"map-style-dark-img"}
            alt="Dark Theme"
            onClick={this.onSetMapStyle.bind(
              this,
          ...
          <img
            src={
              "https://assets.hackbotone.com/images/icons/ic_light_map_style.PNG"
            }
            className={"map-style-light-img"}
            alt="Light Theme"
            onClick={this.onSetMapStyle.bind(
              this,
